...
import { updateRecipients } from '~/store/modules/destinatarios/actions';
...
export default function EditarDestinatarios() {
  const destinatario = useSelector(state => state.destinatarios.destinatario);
  ...
  return (
    <Container ref={ref}>
      <Form schema={schema} initialData={destinatario} onSubmit={handleSubmit}>
